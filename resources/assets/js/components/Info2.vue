<template>
	<div>
			...
			<group class="stu_info">
					...
					<x-input title='学院' :value="info['academy']" disabled></x-input>
					<x-input title='专业' :value="info['major']" disabled></x-input>
			...
			<grid :rows="2" style="text-align:center;padding:0;" class="but_group">
					...
					<grid-item  class="item">
							<x-button type="primary" class="btn" @click.native="edit" mini>下一步</x-button>
					</grid-item>
